...
export default function LoginPage() {
    ...
    return (
        <div className="login-form-enter">
            ...
            <div className="relative my-7 h-8">
                <div className="absolute inset-0 flex items-center">
                    <div className="w-full border-t border-border" />
                </div>
                <div className="absolute inset-x-0 top-[calc(50%+10px)] flex justify-center">
                    <span className="px-3 text-xs leading-none text-text-muted">
                        ou continue com
                    </span>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3">
                <a href="/api/auth/google/login" className="surface-soft flex items-center justify-center gap-2.5 rounded-full px-4 py-3 text-sm font-medium text-text-secondary transition-all hover:-translate-y-[1px] active:translate-y-[1px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/20 focus-visible:ring-offset-2 focus-visible:ring-offset-bg-primary">
                ...
                <a href="/api/auth/microsoft/login" className="surface-soft flex items-center justify-center gap-2.5 rounded-full px-4 py-3 text-sm font-medium text-text-secondary transition-all hover:-translate-y-[1px] active:translate-y-[1px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent/20 focus-visible:ring-offset-2 focus-visible:ring-offset-bg-primary">
