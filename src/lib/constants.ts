...
export const SIDEBAR_ITEMS: MenuItem[] = [
    ...
    { label: "Demandas", href: "/demandas", icon: "BarChart3", permissionKey: "demandas:lista:ver" },
    {
        ...
        subItems: [
            ...
            { label: "Timesheet", href: "/financeiro/timesheet", permissionKey: "financeiro:timesheet:ver" },
    ...
    { label: "Jurimetria", href: "/jurimetria", icon: "BarChart3", permissionKey: "relatorios:painel:ver" },
