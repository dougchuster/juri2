...
const PERMISSION_RESOURCES: PermissionResourceDefinition[] = [
    ...
    { module: "publicacoes", moduleLabel: "Publicacoes", resource: "lista", resourceLabel: "Lista", actions: ["ver", "criar", "editar", "excluir", "exportar", "gerenciar"] },
    { module: "publicacoes", moduleLabel: "Publicacoes", resource: "detalhe", resourceLabel: "Detalhe", actions: ["ver", "editar", "excluir", "gerenciar"] },
    ...
    { module: "comunicacao", moduleLabel: "Comunicacao", resource: "lista", resourceLabel: "Lista", actions: ["ver", "criar", "editar", "excluir", "gerenciar"] },
    ...
    { module: "crm", moduleLabel: "CRM", resource: "fluxos", resourceLabel: "Automacoes", actions: ["ver", "criar", "editar", "excluir", "gerenciar"] },
    { module: "crm", moduleLabel: "CRM", resource: "analytics", resourceLabel: "Analytics CRM", actions: ["ver", "exportar", "gerenciar"] },
    { module: "crm", moduleLabel: "CRM", resource: "configuracoes", resourceLabel: "Configuracoes CRM", actions: ["ver", "editar", "gerenciar"] },
    { module: "distribuicao", moduleLabel: "Distribuicao", resource: "painel", resourceLabel: "Painel", actions: ["ver", "editar", "gerenciar"] },
    ...
    { module: "financeiro", moduleLabel: "Financeiro", resource: "escritorio", resourceLabel: "Financeiro do Escritorio", actions: ["ver", "editar", "gerenciar"] },
    ...
    { module: "financeiro", moduleLabel: "Financeiro", resource: "funcionarios", resourceLabel: "Funcionarios", actions: ["ver", "criar", "editar", "excluir", "gerenciar"] },
    ...
    { module: "financeiro", moduleLabel: "Financeiro", resource: "relatorios", resourceLabel: "Relatorios Financeiros", actions: ["ver", "exportar", "gerenciar"] },
    { module: "financeiro", moduleLabel: "Financeiro", resource: "conciliacao", resourceLabel: "Conciliacao Bancaria", actions: ["ver", "editar", "gerenciar"] },
    { module: "financeiro", moduleLabel: "Financeiro", resource: "configuracoes", resourceLabel: "Configuracoes Financeiras", actions: ["ver", "editar", "gerenciar"] },
    ...
    { module: "calculos", moduleLabel: "Calculos Juridicos", resource: "painel", resourceLabel: "Painel", actions: ["ver", "gerenciar"] },
    { module: "protocolos", moduleLabel: "Protocolos", resource: "lista", resourceLabel: "Lista", actions: ["ver", "criar", "editar", "excluir", "gerenciar"] },
    { module: "pecas", moduleLabel: "Pecas com IA", resource: "gerador", resourceLabel: "Gerador", actions: ["ver", "criar", "gerenciar"] },
    { module: "produtividade", moduleLabel: "Produtividade", resource: "painel", resourceLabel: "Painel", actions: ["ver", "exportar", "gerenciar"] },
    { module: "relatorios", moduleLabel: "Relatorios", resource: "painel", resourceLabel: "Painel", actions: ["ver", "exportar", "gerenciar"] },
    { module: "agentes", moduleLabel: "Agentes Juridicos", resource: "painel", resourceLabel: "Painel", actions: ["ver", "gerenciar"] },
    ...
    { module: "admin", moduleLabel: "Admin", resource: "equipe", resourceLabel: "Equipe Juridica", actions: ["ver", "editar", "gerenciar"] },
    { module: "admin", moduleLabel: "Admin", resource: "operacoes", resourceLabel: "Operacoes Juridicas", actions: ["ver", "editar", "gerenciar"] },
    ...
    { module: "admin", moduleLabel: "Admin", resource: "publicacoes", resourceLabel: "Publicacoes Admin", actions: ["ver", "editar", "gerenciar"] },
    ...
    { module: "admin", moduleLabel: "Admin", resource: "integracoes", resourceLabel: "Integracoes", actions: ["ver", "editar", "gerenciar"] },
    { module: "admin", moduleLabel: "Admin", resource: "chatbot", resourceLabel: "Chatbot Triagem", actions: ["ver", "editar", "gerenciar"] },
    { module: "admin", moduleLabel: "Admin", resource: "permissoes", resourceLabel: "Permissoes", actions: ["gerenciar"] },
];
